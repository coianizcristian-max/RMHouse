...
export const AREE = [
  {
    ...
    voci: [
      ...
      { href: '/gestione/notifiche', testo: 'Le mie notifiche' },
...
export function areaDi(path) {
  if (path === '/gestione' || path.startsWith('/gestione/oggi') || path.startsWith('/gestione/appello')
      ...
      || path.startsWith('/gestione/indice') || path.startsWith('/gestione/ingresso')
      || path.startsWith('/gestione/notifiche')) return 'oggi';
