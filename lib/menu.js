...
export const AREE = [
  ...
  },
  {
    ...
    voci: [
      ...
      { href: '/gestione/rinnovi', testo: 'Rinnovi in scadenza' },
  ...
  },
  {
    ...
    voci: [
      ...
      { href: '/gestione/ricevute', testo: 'Ricevute' },
      { href: '/gestione/fatture', testo: 'Fatture' },
      ...
      { href: '/gestione/promo', testo: 'Promozioni' },
    ],
  },
];
...
export function areaDi(path) {
  ...
  if (path.startsWith('/gestione/persone') || path.startsWith('/gestione/certificati')
      || path.startsWith('/gestione/importa') || path.startsWith('/gestione/rinnovi')) return 'persone';
  return 'gestione';
}
